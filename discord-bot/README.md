...
| `/balance [user]` | Cek saldo koin |
| `/daily` | Klaim koin harian (cooldown 20 jam) |
| `/work` | Kerja buat koin (cooldown 30 menit) |
| `/give user:<@user> jumlah:<n>` | Kasih koin ke user lain |
| `/leaderboard` | Top 10 saldo terbanyak di server |
| `/coinflip bet:<n> pilihan:<heads/tails>` | Tebak koin, menang x2 |
| `/slots bet:<n>` | Slot machine (3 sama = jackpot, 2 sama = x1.5) |
